...
export function AnalyticsKpiCard({ label, value, sub, state = 'neutral', meta, hint, variant, wide }) {
  return (
    <article className={`analyticsKpiCard ${variant || 'compact'} ${wide ? 'wide' : ''} ${state}`}>
