...
export const COMMERCIAL_FEATURES = [
  ...
  {
    id: 'cockpit-advanced',
    label: 'Operational Cockpit avanzado',
...
const PRO_FEATURE_ROWS = [
  ...
  { id: 'analytics', label: 'Analytics / Decision Intelligence', status: FEATURE_STATUS.AVAILABLE },
  { id: 'edge-lab', label: 'Edge Lab y directivas operativas', status: FEATURE_STATUS.AVAILABLE },
  { id: 'emotional-journal', label: 'Journal emocional + Emotion Intelligence', status: FEATURE_STATUS.AVAILABLE },
  { id: 'cockpit-advanced', label: 'Operational Cockpit avanzado', status: FEATURE_STATUS.AVAILABLE },
  { id: 'export', label: 'Export JSON / CSV', status: FEATURE_STATUS.AVAILABLE },
  { id: 'broker-sync', label: 'BrokerSync / MT5 — próximamente', status: FEATURE_STATUS.COMING_SOON },
  { id: 'ai-review', label: 'AI Review — próximamente', status: FEATURE_STATUS.COMING_SOON },
];
...
export const COMMERCIAL_PLANS = [
  {
    ...
    subtitle: 'Base operativa para registrar, validar y revisar sin improvisar.',
    headline: 'Base operativa para registrar, validar y revisar sin improvisar.',
    valueNote: 'Precio preferencial durante etapa de expansión. Ideal para ordenar tu proceso diario con evidencia.',
    cta: 'Activar Club',
    recommended: false,
    tone: 'base',
    available: true,
  ...
  },
  {
    ...
    kicker: 'Más elegido',
    badge: 'Más elegido',
    subtitle: 'Analytics, insights y revisión de conducta para traders activos.',
    headline: 'Analytics, insights y revisión de conducta para traders activos.',
    valueNote: 'Precio preferencial durante etapa de expansión. Decision Intelligence sobre tu evidencia real — sin humo de IA ni sync automático.',
    cta: 'Activar Pro',
    recommended: true,
    tone: 'pro',
    available: true,
  ...
  },
  {
    ...
    kicker: '1 a 1',
    badge: '1 a 1',
    subtitle: 'Acompañamiento y feedback personalizado sobre tu proceso.',
    headline: 'Acompañamiento y feedback personalizado sobre tu proceso.',
    valueNote: 'Cupos limitados para traders que necesitan revisión directa y seguimiento. Incluye Pro; no promete automatización técnica.',
